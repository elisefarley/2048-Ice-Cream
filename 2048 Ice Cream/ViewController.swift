                                            ...
                                            if fourthIceCream.location == row[3]{
                                                if !stop && fourthIceCream.value == thirdIceCream.value{
                                                    ...
                                                    if iceCream.value == secondIceCream.value{
                                                        ...
                                                        iceCreamArray.remove(at: secondIndex)
                                                        if firstIndex < secondIndex && firstIndex < thirdIndex && firstIndex < fourthIndex{
                                                            firstIndex -= 3
                                                        }
                                                        else if (firstIndex < secondIndex && firstIndex < thirdIndex) || (firstIndex < thirdIndex && firstIndex < fourthIndex) || (firstIndex < secondIndex && firstIndex < fourthIndex){
                                                            firstIndex -= 2
                                                        }
                                                        else if firstIndex < secondIndex || firstIndex < thirdIndex || firstIndex < fourthIndex{
                                                            firstIndex -= 1
                                                        }
                                                        iceCreamArray.remove(at: firstIndex)
